...
.PARAMETER MakeDelta
    ...
    If this is true, you should set UseGitHubDelta to true.
...
.PARAMETER PublishGeneric
    ...
    Publishes a generic package that can be uploaded to any other website (e.g. GitHub Releases).
...
.EXAMPLE
  .\Publish.ps1 -ProjectPath "GBFRSiegfriedButBetter.csproj" -PackageName "GBFRSiegfriedButBetter" -PublishOutputDir "Publish/ToUpload"
...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "GBFRSiegfriedButBetter.csproj",
    $PackageName = "GBFRSiegfriedButBetter",
